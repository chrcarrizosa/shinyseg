...
:::{.callout-note}
This option accepts various input formats, but it can be finicky with empty cells. For this reason, we recommend replacing these with dots to ensure smooth processing.
:::
